...
public class MatchOdds {
    ...
    public MatchOdds generateRandomOdds() {
        ...
        this.awayWinsOdds = BigDecimal.valueOf(0.1 + (5 - 0.1) * random.nextDouble())
                .setScale(1, RoundingMode.HALF_DOWN)
                .doubleValue();
        this.homeWinsOdds = BigDecimal.valueOf(0.1 + (5 - 0.1) * random.nextDouble())
                .setScale(1, RoundingMode.HALF_DOWN)
                .doubleValue();
        this.drawOdds = BigDecimal.valueOf(0.1 + (5 - 0.1) * random.nextDouble())
                .setScale(1, RoundingMode.HALF_DOWN)
                .doubleValue();
